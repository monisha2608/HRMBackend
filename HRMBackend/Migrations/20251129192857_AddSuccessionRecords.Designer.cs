...
namespace HRMBackend.Migrations
{
    ...
    [Migration("20251129192857_AddSuccessionRecords")]
    partial class AddSuccessionRecords
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRM.Backend.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("HRM.Backend.Models.Application", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRM.Backend.Models.SuccessionRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PotentialNextRole")
                        .HasMaxLength(160)
                        .HasColumnType("nvarchar(160)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HRM.Backend.Models.AppUser", null)
                        .WithMany()
